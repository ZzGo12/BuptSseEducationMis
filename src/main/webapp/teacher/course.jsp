        ...
        <fieldset>
            ...
            <div class="myborder">
                <div class="form-group mydivmargin">
                    ...
                    <!-- Text input-->
                    <label class="control-label col-lg-offset-2 col-lg-2" for="input01">课程名</label>
                    <div class="col-lg-4">
                        <input type="text" placeholder="请输入课程名" class="form-control" id="input01" name="name">
                ...
                <div class="form-group mydivmargin">
                    ...
                    <!-- Text input-->
                    <label class="control-label col-lg-offset-2 col-lg-2" for="input02">学分</label>
                    <div class="col-lg-4">
                        <input type="text" placeholder="请输入学分" class="form-control" id="input02" name="credit">
                        <p class="help-block mytext"></p>
                    </div>
                </div>
                ...
                <div class="form-group mydivmargin">
                    ...
                    <!-- Select Basic -->
                    <label class="control-label col-lg-offset-2 col-lg-2">学期</label>
                    <div class="col-lg-4">
