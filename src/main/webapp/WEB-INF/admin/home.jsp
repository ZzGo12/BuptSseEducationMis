...
<div class="layout-admin">
    <header class="layout-header">
        <span class="header-logo">北邮教务选课系统后台管理</span>
        ...
        <ul class="header-bar">
            ...
            <li class="header-bar-nav">
                <a href="javascript:;">${sessionScope.admin.username}<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
                <ul class="header-dropdown-menu">
                    <li><a href="${pageContext.request.contextPath}/logout/admin">退出</a></li>
                </ul>
            </li>
            <li class="header-bar-nav">
